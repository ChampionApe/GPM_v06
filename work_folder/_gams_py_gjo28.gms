...
qS.fx[t,s,n]$(((output_CES_CET[s,n] and ( not ((endo_qS_CES_CET[s,n] and t0[t])))) or (endo_qS_CES_CET[s,n] and t0[t]))) = qS.l[t,s,n];
pD.fx[t,s,n]$(input_CES_CET[s,n]) = pD.l[t,s,n];
sigma.fx[s,n]$(kninp_CES_CET[s,n]) = sigma.l[s,n];
eta.fx[s,n]$(knout_CES_CET[s,n]) = eta.l[s,n];
mu.fx[s,n,nn]$((exomu_CES_CET[s,n,nn] or ( not (exomu_CES_CET[s,n,nn])))) = mu.l[s,n,nn];
pD.lo[t,s,n]$(int_CES_CET[s,n]) = -inf;
pD.up[t,s,n]$(int_CES_CET[s,n]) = inf;
pS.lo[t,s,n]$((((output_CES_CET[s,n] and tx0[t]) or (endo_pS_CES_CET[s,n] and t0[t])) or ((output_CES_CET[s,n] and t0[t]) and ( not ((endo_pS_CES_CET[s,n] and t0[t])))))) = -inf;
pS.up[t,s,n]$((((output_CES_CET[s,n] and tx0[t]) or (endo_pS_CES_CET[s,n] and t0[t])) or ((output_CES_CET[s,n] and t0[t]) and ( not ((endo_pS_CES_CET[s,n] and t0[t])))))) = inf;
qD.lo[t,s,n]$(((((int_CES_CET[s,n] or input_CES_CET[s,n]) and tx0[t]) or (endo_qD_CES_CET[s,n] and t0[t])) or (((int_CES_CET[s,n] or input_CES_CET[s,n]) and t0[t]) and ( not ((endo_qD_CES_CET[s,n] and t0[t])))))) = -inf;
qD.up[t,s,n]$(((((int_CES_CET[s,n] or input_CES_CET[s,n]) and tx0[t]) or (endo_qD_CES_CET[s,n] and t0[t])) or (((int_CES_CET[s,n] or input_CES_CET[s,n]) and t0[t]) and ( not ((endo_qD_CES_CET[s,n] and t0[t])))))) = inf;
