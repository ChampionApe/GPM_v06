...
qS.fx[t,s,n]$(((output_FunkyTree[s,n] and ( not ((endo_qS_FunkyTree[s,n] and t0[t])))) or (endo_qS_FunkyTree[s,n] and t0[t]))) = qS.l[t,s,n];
...
mu.fx[s,n,nn]$((exomu_FunkyTree[s,n,nn] or ( not (exomu_FunkyTree[s,n,nn])))) = mu.l[s,n,nn];
pD.lo[t,s,n]$(int_FunkyTree[s,n]) = -inf;
pD.up[t,s,n]$(int_FunkyTree[s,n]) = inf;
pS.lo[t,s,n]$((((output_FunkyTree[s,n] and tx0[t]) or (endo_pS_FunkyTree[s,n] and t0[t])) or ((output_FunkyTree[s,n] and t0[t]) and ( not ((endo_pS_FunkyTree[s,n] and t0[t])))))) = -inf;
pS.up[t,s,n]$((((output_FunkyTree[s,n] and tx0[t]) or (endo_pS_FunkyTree[s,n] and t0[t])) or ((output_FunkyTree[s,n] and t0[t]) and ( not ((endo_pS_FunkyTree[s,n] and t0[t])))))) = inf;
qD.lo[t,s,n]$(((((int_FunkyTree[s,n] or input_FunkyTree[s,n]) and tx0[t]) or (endo_qD_FunkyTree[s,n] and t0[t])) or (((int_FunkyTree[s,n] or input_FunkyTree[s,n]) and t0[t]) and ( not ((endo_qD_FunkyTree[s,n] and t0[t])))))) = -inf;
qD.up[t,s,n]$(((((int_FunkyTree[s,n] or input_FunkyTree[s,n]) and tx0[t]) or (endo_qD_FunkyTree[s,n] and t0[t])) or (((int_FunkyTree[s,n] or input_FunkyTree[s,n]) and t0[t]) and ( not ((endo_qD_FunkyTree[s,n] and t0[t])))))) = inf;
