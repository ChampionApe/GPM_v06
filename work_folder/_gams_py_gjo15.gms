...
qS.fx[t,s,n]$((output_CES2[s,n] and ( not ((endo_qS_CES2[s,n] and t0[t]))))) = qS.l[t,s,n];
pD.fx[t,s,n]$(input_CES2[s,n]) = pD.l[t,s,n];
sigma.fx[s,n]$(kninp_CES2[s,n]) = sigma.l[s,n];
eta.fx[s,n]$(knout_CES2[s,n]) = eta.l[s,n];
mu.fx[s,n,nn]$(exomu_CES2[s,n,nn]) = mu.l[s,n,nn];
qD.fx[t,s,n]$((((int_CES2[s,n] or input_CES2[s,n]) and t0[t]) and ( not ((endo_qD_CES2[s,n] and t0[t]))))) = qD.l[t,s,n];
pS.fx[t,s,n]$(((output_CES2[s,n] and t0[t]) and ( not ((endo_pS_CES2[s,n] and t0[t]))))) = pS.l[t,s,n];
pD.lo[t,s,n]$(int_CES2[s,n]) = -inf;
pD.up[t,s,n]$(int_CES2[s,n]) = inf;
pS.lo[t,s,n]$(((output_CES2[s,n] and tx0[t]) or (endo_pS_CES2[s,n] and t0[t]))) = -inf;
pS.up[t,s,n]$(((output_CES2[s,n] and tx0[t]) or (endo_pS_CES2[s,n] and t0[t]))) = inf;
qD.lo[t,s,n]$((((int_CES2[s,n] or input_CES2[s,n]) and tx0[t]) or (endo_qD_CES2[s,n] and t0[t]))) = -inf;
qD.up[t,s,n]$((((int_CES2[s,n] or input_CES2[s,n]) and tx0[t]) or (endo_qD_CES2[s,n] and t0[t]))) = inf;
...
mu.lo[s,n,nn]$(( not (exomu_CES2[s,n,nn]))) = -inf;
mu.up[s,n,nn]$(( not (exomu_CES2[s,n,nn]))) = inf;
qS.lo[t,s,n]$((endo_qS_CES2[s,n] and t0[t])) = -inf;
qS.up[t,s,n]$((endo_qS_CES2[s,n] and t0[t])) = inf;
