...
qS.fx[t,s,n]$((output_CES1_norm[s,n] and ( not ((endo_qS_CES1_norm[s,n] and t0[t]))))) = qS.l[t,s,n];
...
mu.fx[s,n,nn]$(exomu_CES1_norm[s,n,nn]) = mu.l[s,n,nn];
qD.fx[t,s,n]$((((int_CES1_norm[s,n] or input_CES1_norm[s,n]) and t0[t]) and ( not ((endo_qD_CES1_norm[s,n] and t0[t]))))) = qD.l[t,s,n];
pS.fx[t,s,n]$(((output_CES1_norm[s,n] and t0[t]) and ( not ((endo_pS_CES1_norm[s,n] and t0[t]))))) = pS.l[t,s,n];
pD.lo[t,s,n]$(int_CES1_norm[s,n]) = -inf;
pD.up[t,s,n]$(int_CES1_norm[s,n]) = inf;
pS.lo[t,s,n]$(((output_CES1_norm[s,n] and tx0[t]) or (endo_pS_CES1_norm[s,n] and t0[t]))) = -inf;
pS.up[t,s,n]$(((output_CES1_norm[s,n] and tx0[t]) or (endo_pS_CES1_norm[s,n] and t0[t]))) = inf;
qD.lo[t,s,n]$((((int_CES1_norm[s,n] or input_CES1_norm[s,n]) and tx0[t]) or (endo_qD_CES1_norm[s,n] and t0[t]))) = -inf;
qD.up[t,s,n]$((((int_CES1_norm[s,n] or input_CES1_norm[s,n]) and tx0[t]) or (endo_qD_CES1_norm[s,n] and t0[t]))) = inf;
...
mu.lo[s,n,nn]$(( not (exomu_CES1_norm[s,n,nn]))) = -inf;
mu.up[s,n,nn]$(( not (exomu_CES1_norm[s,n,nn]))) = inf;
qS.lo[t,s,n]$((endo_qS_CES1_norm[s,n] and t0[t])) = -inf;
qS.up[t,s,n]$((endo_qS_CES1_norm[s,n] and t0[t])) = inf;

# ----------------------------------------------------------------------------------------------------
#  Define CES1_norm_C model
# ----------------------------------------------------------------------------------------------------
Model CES1_norm_C /
E_zp_out_CES1, E_zp_nout_CES1, E_q_out_CES1, E_q_nout_CES1
/;
