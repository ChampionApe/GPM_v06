...
qS.fx[t,s,n]$((output_FunnyName[s,n] and ( not ((endo_qS_FunnyName[s,n] and t0[t]))))) = qS.l[t,s,n];
...
mu.fx[s,n,nn]$(exomu_FunnyName[s,n,nn]) = mu.l[s,n,nn];
qD.fx[t,s,n]$((((int_FunnyName[s,n] or input_FunnyName[s,n]) and t0[t]) and ( not ((endo_qD_FunnyName[s,n] and t0[t]))))) = qD.l[t,s,n];
pS.fx[t,s,n]$(((output_FunnyName[s,n] and t0[t]) and ( not ((endo_pS_FunnyName[s,n] and t0[t]))))) = pS.l[t,s,n];
pD.lo[t,s,n]$(int_FunnyName[s,n]) = -inf;
pD.up[t,s,n]$(int_FunnyName[s,n]) = inf;
pS.lo[t,s,n]$(((output_FunnyName[s,n] and tx0[t]) or (endo_pS_FunnyName[s,n] and t0[t]))) = -inf;
pS.up[t,s,n]$(((output_FunnyName[s,n] and tx0[t]) or (endo_pS_FunnyName[s,n] and t0[t]))) = inf;
qD.lo[t,s,n]$((((int_FunnyName[s,n] or input_FunnyName[s,n]) and tx0[t]) or (endo_qD_FunnyName[s,n] and t0[t]))) = -inf;
qD.up[t,s,n]$((((int_FunnyName[s,n] or input_FunnyName[s,n]) and tx0[t]) or (endo_qD_FunnyName[s,n] and t0[t]))) = inf;
...
mu.lo[s,n,nn]$(( not (exomu_FunnyName[s,n,nn]))) = -inf;
mu.up[s,n,nn]$(( not (exomu_FunnyName[s,n,nn]))) = inf;
qS.lo[t,s,n]$((endo_qS_FunnyName[s,n] and t0[t])) = -inf;
qS.up[t,s,n]$((endo_qS_FunnyName[s,n] and t0[t])) = inf;

# ----------------------------------------------------------------------------------------------------
#  Define FunnyName_C model
# ----------------------------------------------------------------------------------------------------
Model FunnyName_C /
